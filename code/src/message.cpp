...
Message::Message(std::string p_author_nick_name, unsigned long long p_author_uuid, unsigned long p_chat_room_index, std::string p_content) : 
	author_nick_name(p_author_nick_name), author_uuid(p_author_uuid), chat_room_index(p_chat_room_index), content(p_content), checksum(calculateChecksum()) {}
