...
public:
	...
	View(Model& parameter_chat_building) : chat_building(parameter_chat_building) {}; //this assigns model in this class to the model in controller when an instance of this class is made in controller.
